...
object LightningMessageCodecs {
  ...
  final val FHC_INVOKE_HOSTED_CHANNEL_TAG = 55535

  final val FHC_INIT_HOSTED_CHANNEL_TAG = 55533

  final val FHC_LAST_CROSS_SIGNED_STATE_TAG = 55531

  final val FHC_STATE_UPDATE_TAG = 55529

  final val FHC_STATE_OVERRIDE_TAG = 55527

  final val FHC_HOSTED_CHANNEL_BRANDING_TAG = 55525

  final val FHC_ANNOUNCEMENT_SIGNATURE_TAG = 55523

  final val FHC_RESIZE_CHANNEL_TAG = 55521

  final val FHC_QUERY_PUBLIC_HOSTED_CHANNELS_TAG = 55519

  final val FHC_REPLY_PUBLIC_HOSTED_CHANNELS_END_TAG = 55517

  final val FHC_QUERY_PREIMAGES_TAG = 55515

  final val FHC_REPLY_PREIMAGES_TAG = 55513

  final val FHC_ASK_BRANDING_INFO = 55511


  final val PFHC_ANNOUNCE_GOSSIP_TAG = 54513

  final val PFHC_ANNOUNCE_SYNC_TAG = 54511

  final val PFHC_UPDATE_GOSSIP_TAG = 54509

  final val PFHC_UPDATE_SYNC_TAG = 54507


  final val FHC_UPDATE_ADD_HTLC_TAG = 53505

  final val FHC_UPDATE_FULFILL_HTLC_TAG = 53503

  final val FHC_UPDATE_FAIL_HTLC_TAG = 53501

  final val FHC_UPDATE_FAIL_MALFORMED_HTLC_TAG = 53499

  final val FHC_ERROR_TAG = 53497
